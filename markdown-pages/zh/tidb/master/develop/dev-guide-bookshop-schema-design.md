...
3. 选择 **Data Format** 为 **TiDB Dumpling**。
   ...
   ![在 TiDB Cloud 中导入 Bookshop 数据](https://download.pingcap.com/images/docs-cn/develop/tidb_cloud_import_bookshop_data.png)

4. 输入你的数据库登录信息。
5. 点击 **Import** 按钮确认导入。
6. 等待 TiDB Cloud 完成数据导入。

   ![Bookshop 数据导入中](https://download.pingcap.com/images/docs-cn/develop/importing_bookshop_data.png)
