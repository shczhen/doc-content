...
![登录](https://download.pingcap.com/images/docs-cn/figma-guide/sign-up.png)
...
![tidb-sketch-book](https://download.pingcap.com/images/docs-cn/figma-guide/tidb-sketch-book.png)

### 第 3 步：创建 Frame

1. 点击 **Back to Files** 查看可浏览或可编辑的文件。

    ![Back to Files](https://download.pingcap.com/images/docs-cn/figma-guide/back-to-files.png)

    ![Recently viewed](https://download.pingcap.com/images/docs-cn/figma-guide/recently-viewed.png)

2. 右击 tidb-sketch-book，选择 **Duplicate**，可生成新文件 **tidb-sketch-book (Copy)**。

    ![Duplicate](https://download.pingcap.com/images/docs-cn/figma-guide/duplicate.png)

    ![tidb-sketch-book (Copy)](https://download.pingcap.com/images/docs-cn/figma-guide/tidb-sketch-book-copy.png)

3. 右击 **tidb-sketch-book (Copy)** 文件，选择 **Rename** 修改文件名称。本示例中，文件更名为 figma-test。

    ![Rename](https://download.pingcap.com/images/docs-cn/figma-guide/rename.png)

    ![figma-test](https://download.pingcap.com/images/docs-cn/figma-guide/figma-test.png)
...
4. 双击更名后的文件。选择 **Frame** 工具 (F)，在屏幕中拖动鼠标生成一个 Frame（画框）。本示例中，生成 Frame 19。
    ...
    ![Frame](https://download.pingcap.com/images/docs-cn/figma-guide/frame.png)

    ![新 Frame](https://download.pingcap.com/images/docs-cn/figma-guide/new-frame.png)
...
1. 选中图形，点击右侧属性栏中 Design 选项卡的 Fill 选项打开拾色器。
    ...
    ![Fill](https://download.pingcap.com/images/docs-cn/figma-guide/fill.png)

2. 为了准确取到某个像素点的颜色，点击 Fill 中的颜色小卡片，再点击弹出的颜色选择器中的吸管工具，即可调出吸管工具（快捷键：<kbd>I</kbd> 或者 <kbd>Ctrl</kbd>+<kbd>C</kbd>）。

    ![吸管工具](https://download.pingcap.com/images/docs-cn/figma-guide/eyedropper.png)

3. 使用吸管工具吸取对应像素色块的颜色，放大镜窗口会显示取样像素的颜色和 hex 编码。

    ![放大镜窗口](https://download.pingcap.com/images/docs-cn/figma-guide/magnifier-window.png)
...
1. 在图层面板中选中待编辑的对象所在的图层，使用快捷键 <kbd>Command</kbd>+<kbd>C</kbd> 复制这些对象。
    ...
    ![Copy objects](https://download.pingcap.com/images/docs-cn/figma-guide/copy-objects.png)
...
![Corner Radius](https://download.pingcap.com/images/docs-cn/figma-guide/corner-radius.png)
...
1. 选中待导出的 Frame，点击 **Export** 一栏的 **+**。
    ...
    ![导出](https://download.pingcap.com/images/docs-cn/figma-guide/export.png)

2. 设置图片格式。可导出为 **PNG（推荐）**、JPG、SVG 或 PDF 格式。

    ![图片格式](https://download.pingcap.com/images/docs-cn/figma-guide/figure-format.png)

3. 点击 **Export Frame X** 按钮导出 Frame。

    ![Export Frame X](https://download.pingcap.com/images/docs-cn/figma-guide/export-frame-x.png)
