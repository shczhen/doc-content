...
3. Click **Initialize**. The **Approve VPC Peerings** dialog is displayed.
    ...
    ![Add VPC peering](https://download.pingcap.com/images/docs/tidb-cloud/vpc-peering/tidb-cloud-vpc-peering-env-check-information.png)
...
2. Click **Add**, choose the Google Cloud icon, and then fill in the required information of your existing GCP VPC:
    ...
    ![VPC-Peering](https://download.pingcap.com/images/docs/tidb-cloud/VPC-Peering2.png)
